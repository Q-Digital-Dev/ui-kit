...
exports.Input = (0, react_1.forwardRef)(function Input(_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)(styledComponents_1.View, { style: containerStyle, className: containerClassName, children: [label && ((0, jsx_runtime_1.jsx)(styledComponents_1.Text, { className: "text-black font-bold mb-1 text-lg", children: label })), (0, jsx_runtime_1.jsxs)(styledComponents_1.View, { className: (0, classnames_1.default)('w-full flex-row border border-solid border-black/10 rounded-lg px-2', inputContainerClassName, {
                ...
                }), style: inputContainerStyle, children: [(0, jsx_runtime_1.jsx)(styledComponents_1.View, { className: "flex-row", children: leftElement }), (0, jsx_runtime_1.jsx)(InputElement, __assign({ className: (0, classnames_1.default)("h-10 flex-1 p-0 py-0 pb-0 pt-0 text-base leading-5 w-full text-black bg-transparent", className), placeholderTextColor: placeholderTextColor || '#00000080', ref: inputRef, setClearState: setClearState, secureTextEntry: isSecureTextEntry }, p)), (0, jsx_runtime_1.jsxs)(styledComponents_1.View, { className: "flex-row", children: [clearState && isShowClear && ((0, jsx_runtime_1.jsx)(styledComponents_1.TouchableOpacity, { className: "px-2 py-1 justify-center items-center", onPress: function () {
                                    var _a;
