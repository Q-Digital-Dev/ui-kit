...
exports.Input = (0, react_1.forwardRef)(function Input(_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)(react_native_1.View, { style: containerStyle, className: containerClassName, children: [label && ((0, jsx_runtime_1.jsx)(react_native_1.Text, { className: "text-black font-bold mb-1 text-lg", children: label })), (0, jsx_runtime_1.jsxs)(react_native_1.View, { className: (0, classnames_1.default)('w-full flex-row border border-solid border-black/10 rounded-lg px-2', inputContainerClassName, {
                    ...
                    'pr-0': rightElement || (isShowClear && clearState),
                                ...
                                }, children: (0, jsx_runtime_1.jsx)(times_svg_1.default, {}) })), isPassword && ((0, jsx_runtime_1.jsx)(react_native_1.TouchableOpacity, { className: "px-2 py-1 justify-center items-center", onPress: function () { return setIsSecureTextEntry(!isSecureTextEntry); }, children: isSecureTextEntry ? (0, jsx_runtime_1.jsx)(closedEye_svg_1.default, {}) : (0, jsx_runtime_1.jsx)(openedEye_svg_1.default, {}) })), rightElement] })] }), error && (0, jsx_runtime_1.jsx)(react_native_1.Text, { className: "text-red-500 mt-1 text-sm", children: error })] }));
});
